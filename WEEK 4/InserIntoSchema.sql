...
SELECT customer_id, region_id, node_id, start_date, end_date FROM(
VALUES
  ...
  )  AS sub (customer_id, region_id, node_id, start_date, end_date) ;
...
SELECT customer_id, txn_date, txn_type, txn_amount FROM (
VALUES
  ...
  ) AS SUB (customer_id, txn_date, txn_type, txn_amount);